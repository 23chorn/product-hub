...
> **Backlog Agent handoff note:** The Backlog Agent requires four sections to generate good stories:
> Problem Statement, User Personas, Key User Journeys, and Functional Requirements (this section).
> Success Metrics are helpful but not blocking. Non-Functional Requirements (step 10), Domain Compliance,
> and Innovation Analysis are supplementary — the Backlog Agent can operate without them.
> If producing a PRD specifically for backlog handoff, these four sections are the minimum viable PRD.
