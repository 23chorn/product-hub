...
export function MonthNavigation({
  ...
  return (
    <aside className="w-48 bg-white dark:bg-surface-800 border-r border-surface-200 dark:border-surface-700 flex flex-col flex-shrink-0">
      <div className="p-3 border-b border-surface-200 dark:border-surface-700">
        <p className="text-xs font-semibold text-surface-500 dark:text-surface-400 uppercase tracking-wide">Month</p>
      </div>
      <div className="flex-1 overflow-y-auto">
        {isLoading && (
          <div className="p-3 text-sm text-surface-400 dark:text-surface-500">Loading...</div>
        )}
        ...
        {!isLoading && (
          ...
          >
            ...
            <span className="text-xs text-surface-400 dark:text-surface-500">Current</span>
          </button>
        )}
        {/* Past months */}
        {availableMonths
