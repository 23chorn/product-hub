      ...
      <div className="flex-1 min-h-0 overflow-y-auto space-y-3 pb-3">
            ...
            <div key={idx} className="rounded-lg border border-gray-200 dark:border-gray-700 p-3 space-y-2">
              <div className="flex items-start justify-between gap-2">
                ...
                <label className="flex items-center gap-1 flex-shrink-0 cursor-pointer">
                  ...
                  />
                  <span className="text-[10px] text-gray-400 dark:text-gray-500">Skip</span>
                </label>
              </div>
              {!skipped.has(idx) && (
                <>
                  ...
                  <input
                    ...
                    className="w-full text-sm rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-2.5 py-1.5 text-gray-900 dark:text-gray-100 placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-blue-500"
                  />
                </>
              )}
            </div>
        ...
        <div>
          ...
          <textarea
            ...
            rows={2}
            className="w-full text-sm resize-none rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-3 py-2 text-gray-900 dark:text-gray-100 placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-blue-500"
          />
        </div>
      </div>

      {/* Pinned actions */}
      <div className="flex gap-2 pt-3 flex-shrink-0 border-t border-gray-200 dark:border-gray-700">
        <button
        ...
        <button
          onClick={onCancel}
          disabled={loading}
          className="py-2 px-3 text-sm text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 transition-colors"
        >
          Cancel
        </button>
      </div>
...
const SEVERITY_STYLES: Record<string, string> = {
  ...
  minor: 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 border-gray-200 dark:border-gray-700',
};
