...
export function ChangeRequestSection({
  ...
  if (showForm && !crAssessment) {
    return (
      ...
      <div className="w-full max-w-lg space-y-3 bg-white dark:bg-surface-900 rounded-xl shadow-xl p-4 border border-cyan-200 dark:border-cyan-800 mx-4">
        ...
        <div>
          ...
          <select
            ...
            className="w-full rounded-md border border-cyan-300 dark:border-cyan-700 bg-white dark:bg-surface-900 px-2 py-1.5 text-xs font-mono text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-cyan-500"
          >
        ...
        <div>
          ...
          <textarea
            ...
            rows={3}
            className="w-full resize-none rounded-md border border-cyan-300 dark:border-cyan-700 bg-white dark:bg-surface-900 px-3 py-2 text-sm font-mono text-surface-900 dark:text-surface-100 placeholder-surface-400 dark:placeholder-surface-500 focus:outline-none focus:ring-2 focus:ring-cyan-500"
          />
        </div>
