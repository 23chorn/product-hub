...
export function BacklogOverlapPanel({ workflowId, onClose }: Props) {
  ...
  return (
    <div className="bg-surface-50 dark:bg-surface-900 rounded-xl shadow-2xl border border-surface-200 dark:border-surface-700 w-full max-w-3xl max-h-[80vh] flex flex-col">
      {/* Header */}
