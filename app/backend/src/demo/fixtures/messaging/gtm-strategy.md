...
**Primary:** Active self-directed traders (22–40) who currently use Discord or WhatsApp alongside their brokerage. These users already have the social habit; we are removing the context-switch, not building a new behaviour.

**Secondary:** Casual investors (30–50) who follow finance influencers and want a lower-commitment way to learn from peers than joining a Discord server.

---

## Launch Phases

### Phase 0: Pre-launch seeding (4 weeks before GA)
- Recruit 20–30 power users from the existing user base (highest trading frequency, engaged with in-app feedback)
- Grant beta access; seed 5–8 channels with curated initial content (e.g. #aapl-watchers, #macro-watch, #nvda-bulls)
- Goal: day-1 launch has active channels with real conversation history, not empty rooms
...
| Metric | Target |
|---|---|
| % of MAUs using Chat (sent or read) | 25% |
| Channels with >50 active members | 15 |
| Message-to-trade conversion rate | 8% |
| New user registrations via Chat deep link | 2,000 |
| 30-day retention lift (Chat vs non-Chat users) | +15% |

---

## Risk Mitigations

**Risk: Channels are empty at launch → no engagement**
Mitigation: Seeded beta cohort ensures initial content. Moderation team monitors and manually enriches low-activity channels in first 2 weeks.

**Risk: Toxic content damages brand**
